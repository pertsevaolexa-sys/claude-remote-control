...
export function buildDimensionOverlay() {
  ...
  add(V(bx - b.artworkWidthMm / 2 - 200, b.baseHeightMm, bz),
    V(bx - b.artworkWidthMm / 2 - 200, b.baseHeightMm + b.artworkHeightMm, bz),
    `roll-up ${b.artworkHeightMm} mm high`, STATUS.SPECIFIED);
  add(V(bx - b.artworkWidthMm / 2, b.baseHeightMm + b.artworkHeightMm + 160, bz),
    V(bx + b.artworkWidthMm / 2, b.baseHeightMm + b.artworkHeightMm + 160, bz),
